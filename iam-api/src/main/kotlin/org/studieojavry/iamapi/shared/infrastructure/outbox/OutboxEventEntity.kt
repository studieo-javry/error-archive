...
/**
 * iam-api 의 outbox row. 자세한 의미는 docs/outbox-design.md.
 */
@Entity
@Table(
    name = "iam_outbox_event",
    indexes = [
        Index(name = "ix_iam_outbox_pending", columnList = "status, next_retry_at"),
        Index(name = "ix_iam_outbox_sent_for_purge", columnList = "sent_at"),
    ],
)
